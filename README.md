...
### * 資料來源
[台灣證券交易所](https://www.twse.com.tw/zh/) 上市公司股票
...
### * 使用者管理頁面
  ...
  <img  width="50%" src="docs/home.png">
...
### * 即時股價/買入頁面
  ...
  「帳戶總價值」為「目前總資產」＋「持有股票總價值」，會在每日收盤後3:10以收盤價進行計算並更新。  
   ...
   <img  width="50%" src="docs/buy.png">.  
   <img  width="50%" src="docs/result.png">
...
### * 已持有股票/賣出頁面
  ...
  <img  width="50%" src="docs/sell.png">
...
### * 交易狀態
  ...
  <img  width="50%" src="docs/state.png">
...
### * 班級討論版
  ...
  <img  width="50%" src="docs/board.png">.  
  <img  width="50%" src="docs/board2.png">
